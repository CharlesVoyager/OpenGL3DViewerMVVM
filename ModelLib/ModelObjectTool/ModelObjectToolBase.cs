...
namespace OpenGL3DViewerMVVM.ModelObjectTool
{
    ...
    public abstract class ModelObjectToolBase
    {
        ...
        public abstract unsafe bool RayIntersectTriangle(Matrix4 matrix, float[] vertices, Ray ray,
            out int id, out float output);
        public abstract unsafe bool RayIntersectTriangle(Matrix4 matrix, float* vertices, int vertexCount, Ray ray,
            out int id, out float output);
